...
(define (get-items-with-knowledge-takers knowledge-takers)
  (cond
    ((hash? knowledge-takers) (get-items-with-knowledge-takers (list knowledge-takers)))
    ((list? knowledge-takers)
      (for/fold
        ((res empty))
        ((knowledge-taker knowledge-takers))
        (let* ((base-tabtree-filepath ($ file knowledge-taker))
              (all-tree (parse-tab-tree base-tabtree-filepath))
              (knowledge-path ($ take knowledge-taker))
